...
Make sure casing is correct: tpc-h/data/*.csv shold be uppercase

Feed data using ruby ./bin/tpc-h-feed.rb

Make sure local infile is enabled in mysql, using make inline-local

Make sure foreign keys are set!!
